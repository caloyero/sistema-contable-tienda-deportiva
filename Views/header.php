...
<head>
    ...
    <title>Nata_Sport</title>
    <meta name="description" content="Nata Sport Moda a Tu Alcance">
    ...
    <script type="text/javascript" src="ruta/a/datatables.min.js"></script>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-table"></i><a href="./copias_blanco_y_negro.php">Copias a Blanco
                                y
                                Negro</a></li>
                    </ul>
                </li>
