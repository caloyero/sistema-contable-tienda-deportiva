...
$listar = $controller->showListCipiasBlancoYNegro();
?>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Fotocopias</h4>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Copias Blanco y Negro</strong>
                                        </div>
                                        <div class="card-body">
                                            <table id="tabla" class="table table-striped display">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($listar as $list) {
                                                        ...
                                                        $hojasGlobal = $hojasGlobal + $list['impreciones']; ?>
                                                    <tr>
                                                        <td>
                                                            <?= $list['precio'] ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a role="button" class="btn btn-danger"
                                                                href="../Config/Peticiones.php?peticion=eliminarCopiasBYN&id=<?= $list['id'] ?>">Eliminar</a>
                                                            <a role="button" class="btn btn-info" onclick="mostrar()"
                                                                href="copias_blanco_y_negro.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                    <td>
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center">Imprimir a Blanco Y Negro</h3>
                                </div>
                                <hr>

                                <form action="../Config/Peticiones.php?peticion=crearCopiaBYN" method="post">

                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Cliente</label>
                                        <input id="cc-payment" name="cliente" type="text" class="form-control">
                                    </div>
                                    <div class="form-group has-success">
                                        <label for="cc-name" class="control-label mb-1">Precio</label>
                                        <input id="cc-name" name="precio" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-number" name="impreciones" type="tel"
                                    ...
                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                        ...
                                        <span id="payment-button-amount">Crear Registro</span>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class=" card-body">
                                        ...
                                        <hr>
                                        <form class="" action="../Config/Peticiones.php?peticion=actualizarCopiasBYN"
                                            method="post">

                                            <?php
                                            $id_edit = $_GET['id_edit'];
                                            $editar = $controller->showCopiasBYNById($id_edit);
                                            /* var_dump($editar);
                                            echo $editar->cliente;
                                            */
                                            ...
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Precio</label>
                                                <input id="cc-name" name="precio" type="text"
                                                    class="form-control cc-name valid" value="<?= $editar->precio ?>">
