...
$listar = $controller->showListCopiasColor();
?>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Copias a Color</strong>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a role="button" class="btn btn-danger"
                                                                href="../Config/Peticiones.php?peticion=eliminarCopiasColor&id=<?= $list['id'] ?>">Eliminar</a>
                                                            <a role="button" class="btn btn-info" onclick="mostrar()"
                                                                href="copias_color.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                    <td>
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center">Imprimir a Color</h3>
                                </div>
                                <hr>

                                <form action="../Config/Peticiones.php?peticion=crearCopiaColor" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class=" card-body">
                                        ...
                                        <hr>
                                        <form class="" action="../Config/Peticiones.php?peticion=actualizarCopiasColor"
                                            method="post">

                                            <?php
                                            $id_edit = $_GET['id_edit'];
                                            $editar = $controller->showCopiasColorById($id_edit);
                                            /* var_dump($editar);
                                            echo $editar->cliente;
                                            */
