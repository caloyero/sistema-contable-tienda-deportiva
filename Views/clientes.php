...
$listar = $controller->listarClientes();
?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a role="button" class="btn btn-danger"
                                                                href="../Config/Peticiones.php?peticion=borrarCliente&id=<?= $list['id'] ?>">Eliminar</a>
                                                            <a role="button" class="btn btn-info"
                                                                href="clientes.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <form action="../Config/Peticiones.php?peticion=crearCliente" method="post">

                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1"> Nombre</label>
                                        <input type="text" name="nombre" class="form-control cc-number identified visa">
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text" name="correo" class="form-control  identified visa">

                                        <span class="help-block field-validation-valid" data-valmsg-for="cc-name"
                                            data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="cc-number" class="control-label mb-1">Direccion</label>
                                        <input id="cc-number" name="direccion" type="text"
                                    ...
                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                        ...
                                        <span id="payment-button-amount">Crear Cliente</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            ...
                                            $edit = $controller->ListarClienteById($id);


                                            ?>

                                            <form action="../Config/Peticiones.php?peticion=editarCliente"
                                                method="post">

                                                <input type="hidden" name="id" value="<?= $edit->id ?>">
                                                <input type="hidden" name="id_producto"
                                                    value="<?= $edit->id_producto ?>">
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label mb-1">Telefono</label>
                                                    <input id="cc-name" name="telefono" type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-number" name="correo" type="text"
                                                        class="form-control cc-number identified visa"
                                                        value="<?= $edit->correo ?>">
                                                    <span class="help-block" data-valmsg-for="cc-number"
                                                        data-valmsg-replace="true"></span>
