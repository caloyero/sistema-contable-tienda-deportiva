...
$listar = $controller->listarCategorias();
?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a role="button" class="btn btn-danger"
                                                                href="../Config/Peticiones.php?peticion=borrarCategoria&id=<?= $list['id'] ?>">Eliminar</a>
                                                            <a role="button" class="btn btn-info" onclick="mostrar()"
                                                                href="categorias.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <form action="../Config/Peticiones.php?peticion=crearCategoria" method="post">

                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Nombre de Categoria</label>
                                        <input id="cc-payment" name="nombre" type="text" class="form-control">
                                    </div>

                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                        <i class="fa fa-lock fa-lg"></i>&nbsp;
                                        <span id="payment-button-amount">Crear Categoria</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            ...
                                            $edit = $controller->listarCategoriasById($id);


                                            ?>

                                            <form action="../Config/Peticiones.php?peticion=editarCategoria"
                                                method="post">

                                                <input type="hidden" name="id" value="<?= $edit->id ?>">

                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Nombre de la
                                                        Categoria</label>
                                                ...
                                                <button id="payment-button" type="submit"
                                                    ...
                                                    <i class="fa fa-lock fa-lg"></i>&nbsp;
                                                    <span id="payment-button-amount">Editar Categoria</span>
