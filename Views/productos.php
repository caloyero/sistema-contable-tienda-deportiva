...
$listar = $controller->listarproductos();
?>
                                            ...
                                            <table id="myTable1" class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= number_format($list['precio_venta']) ?>
                                                        </td>
                                                        <td>
                                                            <?= number_format($list['precio_compra']) ?>
                                                        </td>
                                                        <td>
                                                            <img src="../images/<?= $list['imagen'] ?>" alt="50px"
                                                                width="50px" sizes="" srcset="">

                                                        </td>
                                                        <td>
                                                            <a role="button" class="btn btn-danger"
                                                                href="../Config/Peticiones.php?peticion=borrarProducto&id=<?= $list['id'] ?>">Eliminar</a>
                                                            <a role="button" class="btn btn-info"
                                                                href="productos.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <form action="../Config/Peticiones.php?peticion=crearProducto" method="post"
                                    enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Nombre del Prducto</label>
                                        <input id="cc-payment" name="nombre" type="text" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select name="id_categoria">
                                            <?php $controllercategoria = new CategoriasController();
                                            $listarCategoria = $controllercategoria->listarCategorias();
                                    ...
                                    <div class="form-group">
                                        <label for="cc-number" class="control-label mb-1">Cantidad</label>
                                        <input id="cc-number" name="stock" type="tel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_proveedor">
                                            <?php $controllerProveedores = new ProveedoresController();
                                            $listarProveedores = $controllerProveedores->listarProveedores();
                                            foreach ($listarProveedores as $proveedores) { ?>
                                            <option value="<?= $proveedores['id'] ?>">
                                                <?= $proveedores['nombre_de_proveedor'] ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="cc-payment" name="precio_venta" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Precio de Compra</label>
                                        <input id="cc-payment" name="precio_compra" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Imagen</label>
                                        <input id="cc-payment" name="imagen" type="file" class="form-control">
                                    </div>
                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                        <i class="fa fa-lock fa-lg"></i>&nbsp;
                                        <span id="payment-button-amount">Crear Producto</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            ...
                                            $edit = $controller->listarProductosById($id);


                                            ?>

                                            <form action="../Config/Peticiones.php?peticion=editarProducto"
                                                method="post" enctype="multipart/form-data">

                                                <input type="hidden" name="id" value="<?= $edit->id ?>">
                                                <input type="hidden" name="id_categoria"
                                                    value="<?= $edit->id_categoria ?>">
                                                <input type="hidden" name="id_proveedor"
                                                    value="<?= $edit->id_proveedor ?>">

                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Nombre del
                                                        Producto</label>
                                                    <input id="cc-payment" name="nombre" type="text"
                                                        class="form-control" value="<?= $edit->nombre ?>">
                                                </div>
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label mb-1">Producto</label>
                                                    <input id="cc-name" name="producto" type="text"
                                                ...
                                                <div class="form-group">
                                                    <label for="cc-number" class="control-label mb-1">Cantidad</label>
                                                    <input id="cc-number" name="cantidad" type="tel"
                                                        class="form-control cc-number identified visa"
                                                        value="<?= $edit->stock ?>" data-val="true"
                                                        data-val-required="Please enter the card number"
                                                        data-val-cc-number="Please enter a valid card number">
                                                    <span class="help-block" data-valmsg-for="cc-number"
                                                        data-valmsg-replace="true"></span>
                                                ...
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Proveedor</label>
                                                    <input id="cc-payment" name="direccion" type="text"
                                                        value="<?= $edit->proveedor ?>" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Precio de
                                                        Venta</label>
                                                    <input id="cc-payment" name="precio_venta" type="text"
                                                        value="<?= $edit->precio_venta ?>" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Precio de
                                                        Compra</label>
                                                    <input id="cc-payment" name="precio_compra" type="text"
                                                        value="<?= $edit->precio_compra ?>" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Imagen</label>
                                                    <input id="cc-payment" name="imagen" type="file"
                                                        class="form-control">
                                                    <?php if ($edit->imagen): ?>
                                                    <img src="../images/<?php echo $edit->imagen; ?>" width="100">
                                                    <?php endif; ?>
                                                </div>
                                                <button id="payment-button" type="submit"
                                                    class="btn btn-lg btn-info btn-block">
                                                    <i class="fa fa-lock fa-lg"></i>&nbsp;
                                                    <span id="payment-button-amount">Editar Producto</span>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-complete">Completes</span>
                                                    </td>
                                                </tr>
                                                <tr>
