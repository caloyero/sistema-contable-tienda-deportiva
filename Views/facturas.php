...
//$listar = $controller->listarVentasByIdCliente(1);
?>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong class="card-title">Lista de Proveedores</strong>
                                        </div>
                                        <div class="card-body">
                                            <?php $listar = $controller->listarVentasByIdCliente(1); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a role="button" class="btn btn-danger"
                                                                    href="../Config/Peticiones.php?peticion=borrarProveedor&id=<?= $list->id ?>">Eliminar</a>
                                                                <a role="button" class="btn btn-info" onclick="mostrar()"
                                                                    href="proveedores.php?id_edit=<?= $list['id'] ?>">Editar</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                    ...
                    <div class="card-body">
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <form action="../Config/Peticiones.php?peticion=crearProveedor" method="post">

                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Nombre del Proveedor</label>
                                        <input id="cc-payment" name="nombre_de_proveedor" type="text"
                                            class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-payment" name="direccion" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="cc-payment" class="control-label mb-1">Telefono</label>
                                        <input id="cc-payment" name="telefono" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                        ...
                                        <span id="payment-button-amount">Crear Proveedor</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            ...
                                            //$edit = $controller->listarProveedoresById($id);
                                            

                                            ?>

                                            <form action="../Config/Peticiones.php?peticion=actuaizarProveedor"
                                                method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Nombre del
                                                        Proveedor</label>
                                                    <input id="cc-payment" name="nombre_de_proveedor" type="text"
                                                        class="form-control" value="<?= $edit->nombre_de_proveedor ?>">
                                                </div>
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label mb-1">Producto</label>
                                                    <input id="cc-name" name="producto" type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-number" name="cantidad" type="tel"
                                                        ...
                                                        value="<?= $edit->cantidad ?>" data-val="true"
                                                        data-val-required="Please enter the card number"
                                                        data-val-cc-number="Please enter a valid card number">
                                                    <span class="help-block" data-valmsg-for="cc-number"
                                                        data-valmsg-replace="true"></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-payment" name="direccion" type="text"
                                                        value="<?= $edit->direccion ?>" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Telefono</label>
                                                    <input id="cc-payment" name="telefono" type="text"
                                                        value="<?= $edit->telefono ?>" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Precio</label>
                                                ...
                                                <button id="payment-button" type="submit"
                                                    ...
                                                    <i class="fa fa-lock fa-lg"></i>&nbsp;
                                                    <span id="payment-button-amount">Editar Proveedor</span>
